            ...
            <div class="container-fluid">
                ...
                <div class="row">
                     ...
                     <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center p-4">All Teacher</h4>
                               
                                <a href="add_teach.php" class="btn btn-dark" style="margin-left:500px;margin-bottom:50px;">Add New Teacher</a>
