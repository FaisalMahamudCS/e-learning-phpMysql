        ...
        <form class="contact100-form validate-form" method="post" action=""  enctype="multipart/form-data">
         ...
         Add Catagory
          ...
          <div class="wrap-input100 validate-input" >
            ...
            <input id="email" class="input100" type="text" name="cat_name" >
          ...
          <div class="wrap-input100 validate-input" >
            <input id="email" class="input100" type="text" name="course" >
            <span class="focus-input100"></span>
          </div>
  
          <label class="label-input100" for="email">Catagory Details</label>
          <div class="wrap-input100 validate-input" >
            <input id="email" class="input100" type="text" name="cat_details" >
            <span class="focus-input100"></span>
          </div>
...
include "connection.php";
      ...
      $teacher_image = $teacher_image."_".date("mjYHis").".".$teacher_image_ext;
        ...
        $insert_teacher = "insert into catagory(cat_name,picture,course,cat_details) values('$cat_name','$teacher_image','$course','$cat_details')";
