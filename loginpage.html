  ...
  <body>
    ...
    <div class="container-contact100">
      <div class="wrap-contact100">
        <form class="contact100-form validate-form" method="POST" action="adminprocess.php">
         ...
         Admin Login
          ...
          <div class="wrap-input100 validate-input" >
            <input id="email" class="input100" type="text" name="id" >
            <span class="focus-input100"></span>
          </div>
  
          <label class="label-input100" for="phone">Enter Your  Password</label>
          <div class="wrap-input100">
            <input id="phone" class="input100" type="password" name="password">
            <span class="focus-input100"></span>
          </div>
  
         
            <input type="submit"  class='contact100-form-btn'  style="margin-left:110px;margin-top:80px" name='submit'>
