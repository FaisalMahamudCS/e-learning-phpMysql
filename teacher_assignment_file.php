                                    ...
                                    <table id="example23" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $get_admin_data = "select * from ass_stud inner join assignment on  ass_stud.course_id=assignment.course_id where teacher_id='$id' ";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row_admin_data['files']; ?></td>
                                         <?php $i++;  } ?>
                                            </tr>
