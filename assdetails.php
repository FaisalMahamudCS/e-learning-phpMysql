...
$teacher_id=$_POST['teacher_id'];
      ...
      $teacher_image = $teacher_image."_".date("mjYHis").".".$teacher_image_ext;
        ...
        $insert_teacher = "insert into assignment_student(assignment_id,course_id,stud_id,file,date,teacher_id) values('$assignment_id','$course_id','$stud_id','$teacher_image','$date','$teacher_id')";
        if($run_insert_teacher = mysqli_query($conn,$insert_teacher)){
            echo "<script>
                alert('teacher Inserted Successfully !!');
                window.open('studentportal1.php','_self')
            </script>";
