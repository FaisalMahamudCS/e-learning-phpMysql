...
$sql="SELECT * from skill where cat_id='$cat_id'";
...
<li class="cards_item">
      <div class="cardc">
        <a class="card_image" href="coursedetails.php?course_id="><img src="image/<?php echo $row['picture'] ?>"  style="height: 300px;"></a>
...
<button class="btn btn-success" style="margin-left: 500px;" >All Course <a href="course.php"></a></button>
